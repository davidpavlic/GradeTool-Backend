...
import com.accenture.gradetool.core.generic.dto.LoginDTO;
...
public class LoginHandler extends AbstractAuthenticationProcessingFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        Student authenticated = ((UserDetailsImpl) authResult.getPrincipal()).getStudent();

        String authenticatedId = authenticated.getId();

        String token = Jwts.builder()
            .setSubject(authenticatedId)
